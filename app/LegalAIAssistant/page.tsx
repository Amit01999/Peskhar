...
export default function LegalAIAssistant() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4">
      ...
      {/* Chat Input Box */}
      <div className="relative bg-white border border-black shadow-md rounded-2xl w-full max-w-2xl p-4 flex items-center space-x-3">
      ...
      <div className="flex flex-wrap justify-center gap-3 mt-5">
        {[
          ...
          <button
            key={index}
            className="px-4 py-2  bg-gray-200 rounded-full border text-sm flex items-center gap-2"
          >
            {option === 'More' ? (
